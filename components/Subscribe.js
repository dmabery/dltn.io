...
const Subscribe = () => {
    return (
        <div id="revue-embed" className="p-4 bg-white rounded-lg border border-gray-200 shadow-md sm:p-4 lg:p-6 dark:bg-gray-900 mt-7 mb-7">
            ...
            <h3 class="text-xl font-medium text-gray-900 dark:text-white -mb-5 -mt-1">Subscribe to The Bookshelf</h3>
            ...
            <div className="text-sm text-white">
                See <a href="https://www.getrevue.co/profile/maberydalton"><span className="text-slate-300 hover:underline">past issues</span></a>
            </div>
            </form>
        </div>
