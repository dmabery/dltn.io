...
const Subscribe = ({ title, placeholder }) => {
  ...
  const formClass = classNames({
    "flex items-center rounded-md font-sansSerif": true,
    "border-gray-100": isLoading,
  });

  const inputClass = classNames({
    "text-sm appearance-none rounded bg-grayAccent border border-[#b3b3b3] w-full text-gray-900/80 mr-2 py-2 px-2 leading-tight focus:border-gray-900": true,
