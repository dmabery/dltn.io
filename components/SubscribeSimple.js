        ...
        <div id="revue-embed">
            ...
            <div className="flex-row">
                <div className="revue-form-group mb-2">
                    <input placeholder="Your email address..." type="email" name="member[email]" id="member_email" className="revue-form-field border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 w-full pl-1.5 pt-1 pb-1 dark:border-gray-500 dark:placeholder-gray-400 dark:text-white" onChange={changeEmail} />
                </div>
