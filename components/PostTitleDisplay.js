    ...
    return (
             ...
             <Meta title={props.title || ''} description={props.description || ''} image={props.image || ''} />
                <article className=" mx-auto max-w-screen-md" >
                  ...
                  <div className="prose prose-invert max-w-screen-md prose:ml-0 font-light underline-offset-2 prose-strong:text-gray-100 text-gray-200 prose-a:text-blue-500 prose-a:decoration-slate-500 hover:prose-a:no-underline prose-h1:leading-tight prose-h3:text-slate-300 prose-h4:text-slate-300 sm:prose-h1:leading-tight prose-blockquote:border-none prose-blockquote:font-normal prose-blockquote:bg-slate-400/40 prose-blockquote:rounded prose-blockquote:leading-normal prose-blockquote:p-1 prose-blockquote:pl-5 prose-blockquote:pr-5 prose-blockquote:not-italic">
