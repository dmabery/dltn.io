...
// Strip markdown syntax down to plain text for use in excerpts
  ...
  const rawPosts = files
    ...
    .map((fileName) => {
      ...
      return {
        ...
        excerpt: frontmatter.Description || stripMarkdown(finalContent).slice(0, 150) + '...', // Create an excerpt if not provided
