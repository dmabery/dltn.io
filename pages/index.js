...
export default function Home({posts, tags}) {
  ...
  return (
    ...
    <div className="flex flex-col">
      ...
      <div className='font-serif mb-5 text-stone-800/70'>I like to read. Every Friday, I share five interesting things I discovered that will help you live a more deliberate and curious life. Read previous editions <Link href="/tags/221b"><a className='text-blue-700 hover:text-blue-900 hover:underline'>here</a></Link>. Subscribe below:</div>
