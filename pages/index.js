...
export default function Home({posts, tags}) {
  ...
  return (
    ...
    <div className="flex flex-col">
      ...
      <h3 className="text-3xl md:text-4xl text-[#0C2059] font-extrabold mb-5 italic">Hi, I'm Dalton. By <span className='not-italic'>☀️</span> - I'm a video editor and designer at Farnam Street. By <span className='not-italic'>🌑</span> - I read and write about history's most interesting people and ideas.</h3>
