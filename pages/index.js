...
export default function Home({ posts, tags }) {
  ...
  const posts2026 = posts.filter(item => {
    ...
    <div className="flex flex-col">
      ...
      <h1 className="text-2xl">Hi, I'm Dalton</h1>
        <div className="flex pb-10 border-b flex-col gap-3">
          <p>
            I'm a second-year law student in Sacramento. I write about what I learn studying the law and reading about history.
          </p>
