...
export default function Home({posts, tags}) {
  ...
  return (
    ...
    <div className="flex flex-col">
      ...
      <div className='font-serif mb-5 text-stone-800/70'>I read a lot. Every Friday, I share 5 interesting ideas or stories I found fascinating that week. Read previous editions <Link href="/tags/221b"><a className='text-blue-700 hover:text-blue-900 hover:underline'>here</a></Link>. Subscribe below:</div>
