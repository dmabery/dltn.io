...
const AboutMe = () => {
    return (
        <>
            ...
            <PageContent>
                <div className="prose max-w-screen-lg prose-invert font-light prose-strong:text-neutral-100 text-neutral-300 prose-a:no-underline prose-h1:leading-tight prose-h3:text-slate-300 prose-h4:text-slate-300 sm:prose-h1:leading-tight md:p-0 prose-blockquote:border-none prose-blockquote:font-normal prose-blockquote:bg-slate-400/40 prose-blockquote:rounded prose-blockquote:leading-normal prose-blockquote:p-1 prose-blockquote:pl-5 prose-blockquote:pr-5 prose-blockquote:not-italic">
