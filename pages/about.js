        ...
        <>
            ...
            <div className="container prose underline-offset-2 text-gray-800/80 prose-a:text-blue-700 prose-a:no-underline hover:prose-a:underline hover:prose-a:text-blue-900 prose-h1:leading-tight prose-h2:text-[#0C2059] prose-h2:text-3xl prose-h3:text-2xl prose-h4:text-xl prose-h3:text-[#263459] prose-h4:text-[#263459] sm:prose-h1:leading-tight prose-blockquote:font-normal prose-blockquote:text-neutral-900 prose-blockquote:border-red-500 prose-blockquote:leading-normal prose-blockquote:pl-5 prose-blockquote:not-italic prose-pre:font-normal prose-code:text-white">
                ...
                <h2 id="tldr">Short bio</h2>
                    <p>I&#39;m a professional video editor and designer with four years of social media experience. I have a degree in Digital Media and Design from Southeastern University. I currently work for <a href="https://fs.blog/" rel="noreferrer" target="_blank">Farnam Street </a>. I also <Link href="/writing"><a>write online</a></Link> and share interesting quotes and ideas on <a href="https://twitter.com/dltnio" rel="noreferrer" target="_blank">Twitter</a>. In my free time, I run, read, and write code. I&#39;m studying to become a software engineer. I currently have experience with React, Tailwind, and Next.js</p>
                    <p>I love design, aesthetic, and making things beautiful. There is a delicate balance I try to strike between minimalism and maximalism.</p>
                    <p>I&#39;m curious about why things are the way that they are. Sayings, names, standards, rules; there&#39;s often a fascinating backstory behind them all. I like to learn those stories and share them with others.</p>
                ...
                <h3 id="for-side-projects">For Side projects</h3>
                    <ul>
                        ...
                        <li>Every Friday, I send a weekly newsletter with five interesting stories from history. You can sign up <Link href="/221b"><a>here.</a></Link></li>
                ...
                <h3 id="for-fun">For Fun</h3>
                    <ul>
                        <li>Away from my computer or a book, I either play golf, watch golf, run, or hang out with friends and family. My main leisure activities are golf and running.</li>
                        <li>I realized latley I love to work out like I&#39;m in prison (my friend Ryan Burns used that description of himself and I loved it). I run, use TRX bands in my office, do push ups, some ab workouts, and a stretching routine every morning. I love running because I sweat and when I sweat I think better. I also think it&#39;s the best way to increase your mental discipline. As Seneca said, &quot;We treat the body rigorously so that it may not be disobedient to the mind&quot;.</li>
                    </ul>
