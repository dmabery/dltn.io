    ...
    <div className="container prose text-gray-800 underline-offset-2 prose-h1:leading-tight prose-h2:text-3xl prose-h2:text-[#0C2059] prose-h3:text-2xl prose-h3:text-[#263459] prose-h4:text-xl prose-h4:text-[#263459] prose-a:text-blue-700 prose-a:no-underline hover:prose-a:text-blue-900 hover:prose-a:underline prose-blockquote:border-red-500 prose-blockquote:pl-5 prose-blockquote:font-normal prose-blockquote:not-italic prose-blockquote:leading-normal prose-blockquote:text-neutral-900 prose-code:text-white prose-pre:font-normal sm:prose-h1:leading-tight">
      ...
      <blockquote>
        <p>
          ...
          about the transient present, too little to the living past. We are
          choked with news, and starved of history. We know a thousand items
          about the day or yesterday, we learn the events and troubles and
      ...
      <p>
        ...
        Einstein&#39;s. Not his groundbreaking theories, but his curiosity and
        humility. After his death, The New York Times wrote this: Man stands on
        this diminutive earth, gazes at the myriad of stars and upon billowing
        ocean and tossing trees–and wonders. What does it all mean? How did it
        come about? The most thoughtful wonderer who appeared among us in three
        centuries has passed on in the person of Albert Einstein.
      </p>
      <blockquote>
        <p>
      ...
      <p>
        You can find me on 
        <a href="https://www.twitter.com/dltnio">Twitter</a>
        , 
        <a href="https://github.com/dmabery">GitHub</a>, and 
        <a href="https://www.youtube.com/@dltnio">YouTube</a>.
      </p>
    </div>
  </>
);
