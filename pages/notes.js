    ...
    return (
        <div className="grid grid-row gap-4">
            {posts.map((post, index) => (
                ...
                <Link href={'/notes/' + post.slug} passHref key={index}>
                ...
                <div class="">
                    ...
                    <Link href={'/notes/' + post.slug} passHref key={index} class="inline-flex items-center text-sm font-medium text-center text-slate-500 hover:text-slate-900">
